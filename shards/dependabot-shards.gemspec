...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-shards"
  spec.summary      = "Provides Dependabot support for Crystal (shards)"
  spec.description  = "Dependabot-Shards provides support for bumping Crystal (shards) packages via Dependabot. " \
